            ...
            <div class="box-body">
                <div class="row">
                    {!! Form::model($setting, ['route' => ['settings.update', $setting->id], 'method' => 'patch']) !!}
                        ...
                        <!--weixin_common -->
                        <div class="form-group col-sm-12">
                            {!! Form::label('weixin_common', '公众号二维码:') !!}
                            <div class="input-append">
                                {!! Form::text('weixin_common', null, ['class' => 'form-control', 'id' => 'weixin2']) !!}
                                <a data-toggle="modal" href="javascript:;" data-target="#myModal" class="btn" type="button" onclick="changeImageId('weixin2')">选择图片</a>
                                <img src="@if($setting) {{$setting->weixin_common}} @endif" style="max-width: 100%; max-height: 150px; display: block;">
                            </div>
                        </div>
